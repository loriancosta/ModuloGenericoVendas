    ...
    public class VendasDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ItemVenda>(entity =>
            {
                ...
                entity.Property(e => e.Quantidade).HasColumnName("Quantidade").HasColumnType("decimal(18,2)").IsRequired();
                entity.Property(e => e.PrecoUnitario).HasColumnName("PrecoUnitario").HasColumnType("decimal(18,2)").IsRequired();
                entity.Property(e => e.Desconto).HasColumnName("Desconto").HasColumnType("decimal(18,2)").IsRequired();
